...
// If you don't have it, this component might fail or need a fallback.
...
function InfiniteHero() {
    ...
    useGSAP(
        () => {
            ...
            // Since SplitText is premium and likely not available, 
            // we'll comment out the split logic and use fallback animations.
        ...
        >
            ...
            <div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
                <div className="text-center">
                    <h1
                        ref={h1Ref}
                        className="mx-auto max-w-2xl lg:max-w-3xl text-[clamp(2.25rem,6vw,4rem)] font-extralight leading-[0.95] tracking-tight"
                    >
                        Your Partner for Intelligent Home Automation.
                    </h1>
                    <p
                        ref={pRef}
                        className="mx-auto mt-7 max-w-3xl md:text-balance md:text-base font-medium tracking-tight text-white"
                    >
                        Minimal forms dissolve into the horizon, where space and silence converge, inviting an endless gaze.
                    </p>
